The header/ directory contains codes(mainly header files and associated
standard algorithms) from following links:
micro-ecc->https://github.com/ozgurozmen/OptimizedPKCSuite/tree/master/ATmega2560/micro-ecc
